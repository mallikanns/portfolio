      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-0 lg:justify-center">
          ...
          <div className="flex flex-col-reverse items-center gap-y-0 lg:flex-row lg:items-center lg:gap-x-12">
            <div className="flex-1 text-center font-secondary lg:text-left lg:pl-20">
              <p className="text-rajah mb-10 max-w-lg mx-auto px-4 text-lg lg:mx-0 lg:px-0 lg:max-w-full">I am a career switcher with a background in economics who has transitioned into software development. I am dedicated to continuous learning and eager to leverage my experiences and skills to contribute to innovative technical solutions that drive sustainable growth in Thailand and worldwide.</p>
